  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-6 relative">
        ...
        <input
          type="text"
          placeholder="Pesquisar fornecedores por nome, CNPJ ou telefone..."
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredFornecedores.map((fornecedor) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      {new Date(fornecedor.criado_em).toLocaleDateString(
                        "pt-BR"
                      )}
                    </td>
      ...
      {filteredFornecedores.length > 0 && (
        <div className="mt-4 flex justify-between items-center bg-white px-6 py-3 rounded-b-xl shadow-sm">
          <div className="text-sm text-gray-500">
            Mostrando{" "}
            <span className="font-medium">{filteredFornecedores.length}</span>{" "}
            de <span className="font-medium">{fornecedores.length}</span>{" "}
            fornecedores
          </div>
          <div className="flex space-x-2">
            ...
            <button className="px-3 py-1 rounded-md bg-green-600 text-white hover:bg-green-700 transition">
              Próxima
            </button>
          </div>
        </div>
